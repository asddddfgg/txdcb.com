<%*
// ==========================================
// 🚀 SEO专家版：标签金句收集器（V8 最终修正版 - 移除 onclick）
// 解决：彻底消除 onclick 带来的所有浏览器兼容性问题。
// 方案：完全移除 generateTagHTML 和页脚链接中的 onclick 属性。
// 🚨 警告：移除后，在浏览器中点击链接将尝试打开 Obsidian 软件，而不是跳转到 Quartz 相对路径。
// ==========================================
...
*智能更新完成：${new Date().toLocaleString('zh-CN')}*`;
    ...
    tR += `# ✅ 标签金句收集完成（V8 最终修正版 - 移除 onclick）
