<%*
// ==========================================
// 🌟 Obsidian SEO & 标签金句生成器（网页路径版 for Quartz）
// ==========================================
...
try {
  ...
  for(const tag of Array.from(allTags).sort()){
    ...
    let html = `<div class="tag-header" style="background:${color}"><h1>关于「${tagName}」的名言金句</h1><p>收录 ${contents.length} 条内容</p></div>`;
    html += `<div class="tag-content-wrapper"><div class="tag-content">`;
    ...
    html += `</div><div class="tag-footer"><p>🕐 生成时间：${new Date().toLocaleString()}</p></div></div>`;
